      ...
      <section className="relative min-h-screen flex flex-col justify-center items-center pt-20 overflow-hidden text-center">
        ...
        <div className="container mx-auto px-6 z-10 relative">
          <div className="max-w-[95vw] mx-auto relative">
             ...
             <div className="flex flex-col items-center justify-center relative z-10 max-w-[90vw] md:max-w-[80vw]">
                ...
                <div className="flex items-center justify-center flex-wrap tracking-tight leading-[0.9] w-full mb-2">
                     <span className="text-[10vw] md:text-[6vw] font-display font-black uppercase text-white mix-blend-difference z-10">TRANSFORMING</span>
                </div>

                {/* Line 2 - Visible IDEAS + Portrait */}
                <div className="flex items-center justify-center flex-wrap tracking-tight leading-[0.9] gap-2 md:gap-5 relative z-10 mb-2">
                     <span className="text-[10vw] md:text-[6vw] font-display font-black uppercase text-white hover:text-accent transition-colors duration-300">IDEAS</span>
                     <Magnetic>
                        <div className="w-[16vw] h-[8vw] md:w-[6vw] md:h-[3vw] rounded-full overflow-hidden border-2 border-accent rotate-6 hover:rotate-0 transition-transform duration-500 z-30 relative">
                             <img src={portrait} alt="Portrait" className="w-full h-full object-cover scale-125" />
                        </div>
                     </Magnetic>
                     <span className="text-[10vw] md:text-[6vw] font-display font-black uppercase text-white">INTO</span>
                </div>

                {/* Line 3 - Removed Diamond, kept simple */}
                <div className="flex items-center justify-center flex-wrap tracking-tight leading-[0.9] gap-2 md:gap-5 relative z-10 mb-2">
                    <span className="text-[10vw] md:text-[6vw] font-display font-black uppercase text-accent">REAL</span>
                    <span className="text-[10vw] md:text-[6vw] font-display font-black uppercase text-white">WORLD</span>
                </div>

                 {/* Line 4 - Finish */}
                 <div className="flex items-center justify-center flex-wrap tracking-tight leading-[0.9] relative z-10">
                    <span className="text-[10vw] md:text-[6vw] font-display font-black uppercase text-white">RESULTS</span>
                </div>
             </div>
